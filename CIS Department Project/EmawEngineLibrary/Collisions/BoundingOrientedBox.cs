...
//Modified from a struct to a class to allow nullables.
...
namespace EmawEngineLibrary.Physics
{
    ...
    /// </summary>
    public class BoundingOrientedBox : IEquatable<BoundingOrientedBox>, IBoundingObject
    {
        #region Constants
        ...
        public void Intersects(ref BoundingBox box, out bool intersects)
        {
            intersects = Intersects(box);
        }

        public void Contains(ref BoundingBox box, out ContainmentType type)
        {
            type = Contains(ref box);
        }
        ...
        public void Contains(ref BoundingSphere sphere, out ContainmentType type)
        {
            type = Contains(sphere);
        }
        ...
        public void Intersects(ref BoundingSphere sphere, out bool intersects)
        {
            intersects = Intersects(ref sphere);
        }
        ...
        public void Intersects(ref Ray ray, out float? point)
        {
            point = Intersects(ref ray);
        }
        ...
        public void Intersects (ref Plane plane, out PlaneIntersectionType type)
        {
            type = Intersects(ref plane);
        }
