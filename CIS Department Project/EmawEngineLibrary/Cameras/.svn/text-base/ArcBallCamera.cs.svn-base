...
namespace EmawEngineLibrary
{
    ...
    public class ArcBallCamera : ICamera
    {
        ...
        /// <summary>
        /// Get the Projection (look at) Matrix defined by the camera
        /// </summary>
        public Matrix Projection
        {
            get
            {
                float aspectRatio = (float)860 / 430.0f;
                float fov = MathHelper.PiOver4 * aspectRatio * 3 / 4;
                return Matrix.CreatePerspectiveFieldOfView(fov, aspectRatio, .1f, 1000f); 
            }
        }
